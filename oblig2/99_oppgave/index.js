...
try {
  ...
  (function Demo() {
	...
	//endrer og legger til en "o" for at det skal tilsvare toBe. 
  ...
  /// Template strings ///
	...
	(function UseTemplateStrings1() {
		...
		//La inn dollartegn foran klammene, og byttet ut apstrofene med backticks. 
	...
	(function UseDefaultParameters() {
		...
		//Legger inn = 'World' for å definere "who". 
  ...
  /// Rest parameter ///
	...
	(function UseRestParameter() {
		...
		function foo(a, b, ...args) {
			...
			//legger til en rest parameter med args. Og ber den gå igjennom .lenght til args for å få med seg alle de utestående elementene i arrayem som dannes av args. 
		}
  ...
  /// Spread operator ///
	...
	(function UseSpreadOperator1() {
		...
		//La inn en spread før values for å spre tallene inn i plassene i arrayen. 
	...
	(function UseSpreadOperator2() {
		...
		//Legger inn spread operator på de arrayene som har flere elementer i seg. 
  ...
  /// Arrow functions ///
	...
	(function UseArrow1() {
		...
		//Fjerner function og legger til arrow og plusser x+x for å få det etterpurte 6. 
		let double = (x) => {
			return x+x;
		};
	...
	(function UseArrow2() {
		...
		//Setter parenteser rundt x og y og setter in klammer, og i tillegg bytter gangetegn med plusstegn for å få 8. 
		let add = (x, y) => {
			return x + y;
		};
		// Don't make changes below this line	
  ...
  /// Destructuring ///
	...
	(function UseArrayDestructuring2() {
		...
		//Bruker destructuring til å bytte verdiene i variablene. 
